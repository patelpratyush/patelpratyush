...
# 📚 Skills:
- **Languages**: Java, Python, C++/C, JavaScript, HTML/CSS, SQL, OCaml
- **Libraries**: Tkinter, NumPy, Pandas, RestAPI, TensorFlow, React, Next.js
- **Developer Tools & Technologies**: Git, GitLab, VS Code, Visual Studio, PyCharm, IntelliJ, Eclipse, Jupyter Notebook, Firebase, GCP, Vercel, OpenAI, CI/CD
